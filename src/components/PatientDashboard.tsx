          ...
          <>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Take your medication at 8:00 PM
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Are you a licensed healthcare professional? Apply to become a
                doctor on our platform.
              </p>
              ...
              {!showDoctorApplication ? (
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-blue-800 text-sm mb-4">
                    By clicking confirm, you're applying to become a doctor on
                    our platform. Your application will be reviewed by our admin
                    team.
                  </p>
